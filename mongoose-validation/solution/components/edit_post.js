...
var Field = ({ label, value, onChange, name, error }) => <div className={ styles.field }>
  <label>{ label }</label>
...
var EditPost = React.createClass({
  ...
  render: function() {
    return  <div className={ styles.editor }>
      ...
      <Field label="Your Name" value={ this.state.post.user } name='user' onChange={ this.updateField } error={ this.state.errors.user } />
